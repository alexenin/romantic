        ...
        */
        ...
        public void ClientEvent_saveCharacter(Client player, params object[] args)
        {
            try
            {
                ...
                if (!isChanging)
                {
                    player.SendChatMessage("~y~Добро пожаловать в штат Deep Ocean!");
                    if(!Main.Accounts[player].PresentGet && Main.Accounts[player].PromoCodes[0].Equals("loveu")) {
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Добро пожаловать в штат Deep Ocean! Вы получили первый уровень, Gold VIP на 3 дня и 5000$!", 6000);
