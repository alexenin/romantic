    ...
    { // Revision 3.0
        ...
        public static void onResourceStart()
        {
            try
            {
                ...
                NAPI.Blip.CreateBlip(494, Manager.FractionSpawns[16], 1, 20, Main.StringToU16("Байкеры The Lost"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(590, LSNews.LSNewsCoords[0], 1, 45, Main.StringToU16("Новости"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(419, Cityhall.CityhallCheckpoints[2], 1.5f, 14, Main.StringToU16("Мэрия"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(489, Ems.emsCheckpoints[0], 1, 49, Main.StringToU16("Больница"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(540, Fbi.EnterFBI, 1, 58, Main.StringToU16("ФБР"), 255, 0, true, 0, 0);
                ...
                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[4], 1, 74, Main.StringToU16("Сальвадорская банда"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[5], 1, 49, Main.StringToU16("Кровавые"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[10], 1, 5, Main.StringToU16("Итальянская мафия"), 255, 0, true, 0, 0);
