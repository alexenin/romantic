...
namespace NeptuneEvo.Houses
{
    ...
    class House
    {
        ...
        public void UpdateLabel()
        {
            try
            {
                string text = $"~w~Дом ~b~#{ID}\n\n~w~Класс: ~b~{HouseManager.HouseTypeList[Type].Name}\n";
                if (!string.IsNullOrEmpty(Owner)) text += $"~w~Владелец: ~b~{Owner.Replace('_', ' ')}\n";
                else text += $"~w~Цена: ~b~{Price}$\n";
                if (GarageID != 0) text += $"~w~Г.М: ~b~{GarageManager.GarageTypes[GarageManager.Garages[GarageID].Type].MaxCars}\n";
    ...
    class HouseManager : Script
    {
        ...
        {
            // name, position
            new HouseType("Trailer", new Vector3(1973.124, 3816.065, 32.30873), null, 0.0f, "apa_ch2_12b_interior_0_v_mp_stilts_a_milo_"),
            new HouseType("Econom", new Vector3(151.2052, -1008.007, -100.12), null, 0.0f,"hei_hw1_blimp_interior_v_motel_mp_milo_"),
            new HouseType("Ranch", new Vector3(265.9691, -1007.078, -102.0758), null, 0.0f,"hei_hw1_blimp_interior_v_studio_lo_milo_"),
            new HouseType("Premium", new Vector3(346.6991, -1013.023, -100.3162), new Vector3(349.5223, -994.5601, -99.7562), 264.0f, "hei_hw1_blimp_interior_v_apart_midspaz_milo_"),
            new HouseType("Cottage", new Vector3(-31.35483, -594.9686, 78.9109),  new Vector3(-25.42115, -581.4933, 79.12776), 159.84f, "hei_hw1_blimp_interior_32_dlc_apart_high2_new_milo_"),
            new HouseType("Mansion", new Vector3(-17.85757, -589.0983, 88.99482), new Vector3(-38.84652, -578.466, 88.58952), 50.8f, "hei_hw1_blimp_interior_10_dlc_apart_high_new_milo_"),
            new HouseType("Villa", new Vector3(-173.9419, 497.8622, 136.5341), new Vector3(-164.9799, 480.7568, 137.1526), 40.0f, "apa_ch2_05e_interior_0_v_mp_stilts_b_milo_"),
        };
