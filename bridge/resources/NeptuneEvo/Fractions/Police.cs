...
namespace NeptuneEvo.Fractions
{
    class Police : Script
    {
        ...
        public static void callPolice(Client player, string reason)
        {
            ...
            {
                try {
                    if (Manager.countOfFractionMembers(7) == 0 && Manager.countOfFractionMembers(9) == 0 && Manager.countOfFractionMembers(18) == 0)
                    {
                    ...
                    foreach (var p in NAPI.Pools.GetAllPlayers())
                        {
                            ...
                            if (Main.Players[p].FractionID != 7 && Main.Players[p].FractionID != 9 && Main.Players[p].FractionID != 18) continue;
