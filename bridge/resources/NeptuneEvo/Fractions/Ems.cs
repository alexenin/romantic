...
namespace NeptuneEvo.Fractions
{
    class Ems : Script
    {
        ...
        {
            new Vector3(350.2989, -1417.999, 21.36217),
            //new Vector3(240.7599, -1379.576, 32.74176), // enter ems          0
            new Vector3(275.446, -1361.11, 23.5378), // exit ems       1
            new Vector3(324.9919, -1428.55, 31.39132), // Спавн Убитых Игроков.      2
            new Vector3(361.4716, -1425.974, 31.39111), // Взятие Аптек и Тайзера Склад      3
            new Vector3(375.5172, -1434.793, 31.3911), // Раздевалка       4
            new Vector3(354.9169, -1416.157, 31.39048), // Начало лечения     5
            new Vector3(383.0224, -1401.61, 31.39111), // Удаление Тату      6
            new Vector3(334.211, -1431.55, 45.39097), // roof        7
            new Vector3(372.1866, -1421.297, 31.39044), // to roof          8
        };
