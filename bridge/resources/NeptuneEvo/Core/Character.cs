    ...
    public class Character : CharacterData
    {
            ...
            try
            {
                ...
                foreach (DataRow Row in result.Rows)
                {
                    ...
                    if (Row["pos"].ToString().Contains("NaN"))
                    {
                        ...
                        if(LVL <= 1) new Vector3(-1037.42, -2738.239, 19.04929); // На спавне новичков
                        else SpawnPos = new Vector3(-1037.42, -2738.239, 19.04929); // У мэрии LS Aero end 1
                    }
                }
        ...
        public async Task<int> Create(Client player, string firstName, string lastName)
        {
            try
            {
                ...
                SpawnPos = new Vector3(-1037.42, -2738.239, 19.04929);
