...
namespace NeptuneEvo.Core
{
    class DrivingSchool : Script
    {
        ...
        private static Vector3 enterSchool = new Vector3(-926.2214, -2037.116, 8.279902);
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Автошкола"), new Vector3(enterSchool.X, enterSchool.Y, enterSchool.Z + 1), 5f, 0.3f, 0, new Color(255, 255, 255));
