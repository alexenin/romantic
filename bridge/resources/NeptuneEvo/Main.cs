...
namespace NeptuneEvo
{
    ...
    {
        public static string Codename { get; } = "Deep Ocean RolePlay";
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.World.SetWeather(config.TryGet<string>("Weather", "EXTRASUNNY"));
        ...
        private static string Env_lastWeather = config.TryGet<string>("Weather", "EXTRASUNNY");
        ...
        public static void CMD_BUILD(Client client)
        {
            try
            {
                client.SendChatMessage($"~g~Deep Ocean RolePlay");
                ...
                client.SendChatMessage($"Группа ВК: !{{#a4199a}}https://vk.com/");
                client.SendChatMessage($"Дискорд Сервера: !{{#a4199a}}https://discord.gg/");
            }
            catch { }
        }
